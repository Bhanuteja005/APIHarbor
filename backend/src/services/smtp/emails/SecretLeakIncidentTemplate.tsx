...
export const SecretLeakIncidentTemplate = ({
  ...
  return (
    <BaseEmailWrapper
      ...
      preview="APIHarbor uncovered one or more leaked secrets."
      siteUrl={siteUrl}
    >
      <Heading className="text-black text-[18px] leading-[28px] text-center font-normal p-0 mx-0">
        APIHarbor has uncovered <strong>{numberOfSecrets}</strong> secret(s) from a recent commit
      </Heading>
      <Section className="px-[24px] mb-[28px] mt-[36px] pt-[8px] pb-[8px] text-[14px] border border-solid border-gray-200 rounded-md bg-gray-50">
        ...
        <Text className="text-[14px]">
          ...
          <BaseLink href={`${siteUrl}/organization/secret-scanning`}>APIHarbor Dashboard</BaseLink>.
        </Text>
      </Section>
