...
export const SignupEmailVerificationTemplate = ({ code, siteUrl, isCloud }: SignupEmailVerificationTemplateProps) => {
  return (
    <BaseEmailWrapper
      ...
      preview="Verify your email address to get started with APIHarbor."
      siteUrl={siteUrl}
    >
      ...
      <Section className="mt-[24px] bg-gray-50 pt-[2px] pb-[16px] border border-solid border-gray-200 px-[24px] rounded-md text-gray-800">
        <Text className="mb-[0px]">
          <strong>Questions about setting up APIHarbor?</strong>{" "}
          {isCloud ? (
            <>
              Email us at <BaseLink href="mailto:support@apiharbor.io">support@apiharbor.io</BaseLink>
            </>
          ) : (
