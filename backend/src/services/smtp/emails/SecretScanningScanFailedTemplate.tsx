...
export const SecretScanningScanFailedTemplate = ({
  ...
  return (
    <BaseEmailWrapper
      ...
      preview="APIHarbor encountered an error while attempting to scan for secret leaks."
      siteUrl={siteUrl}
    >
      <Heading className="text-black text-[18px] leading-[28px] text-center font-normal p-0 mx-0">
        APIHarbor encountered an error while attempting to scan the resource <strong>{resourceName}</strong>
      </Heading>
      ...
      <Section className="text-center">
        <BaseButton href={url}>View in APIHarbor</BaseButton>
      </Section>
    </BaseEmailWrapper>
  );
};
