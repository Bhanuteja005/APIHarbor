...
export const OrganizationInvitationTemplate = ({
  ...
  return (
    <BaseEmailWrapper
      ...
      preview="You've been invited to join an organization on APIHarbor."
      siteUrl={siteUrl}
    >
      <Heading className="text-black text-[18px] leading-[28px] text-center font-normal p-0 mx-0">
        You've been invited to join
        <br />
        <strong>{organizationName}</strong> on <strong>APIHarbor</strong>
      </Heading>
      ...
      <Section className="mt-[24px] bg-gray-50 pt-[2px] pb-[16px] border border-solid border-gray-200 px-[24px] rounded-md text-gray-800">
        <Text className="mb-[0px]">
          <strong>About APIHarbor:</strong> APIHarbor is an all-in-one platform to securely manage application secrets,
...
OrganizationInvitationTemplate.PreviewProps = {
  ...
  inviterUsername: "jane@apiharbor.io",
  siteUrl: "https://apiharbor.io",
  callback_url:
    "https://app.apiharbor.io/signupinvite?token=preview-token&to=john%40apiharbor.io&organization_id=1ae1c2c7-8068-461c-b15e-421737868a6a"
