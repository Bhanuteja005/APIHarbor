                ...
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-lg mx-auto">
                        ...
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold font-heading text-center mt-6 !leading-tight">
                            Fortify your keys with health monitoring
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                            Safeguard your integrations with automated health checks, providing peace of mind and enhanced reliability.
                        </p>
                ...
                <AnimationContainer delay={0.2} className="w-full">
                    <div className="w-full flex max-w-4xl py-10 mx-auto">
                        <Image
                            ...
                            alt="Monitor your API keys' health"
                            width={80}
                            height={80}
