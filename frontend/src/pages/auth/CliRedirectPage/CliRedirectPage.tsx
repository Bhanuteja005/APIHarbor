...
export const CliRedirectPage = () => {
  ...
  return (
    <div className="flex flex-col justify-between bg-bunker-800 md:h-screen">
      <Helmet>
        <title>APIHarbor CLI | Login Successful!</title>
        ...
        {cliToken ? (
          <>
            <div className="pb-4">
              ...
              <p className="text-light mt-2 mb-1 text-center text-lg text-mineshaft-400">
                Your login was successful but, APIHarbor couldn&apos;t automatically push your login
                token to the CLI.
              </p>
          ...
          <>
            ...
            <p className="text-light mb-1 text-lg text-mineshaft-400">
              You&apos;ve successfully logged in to the APIHarbor CLI
            </p>
          </>
        )}
      </div>
