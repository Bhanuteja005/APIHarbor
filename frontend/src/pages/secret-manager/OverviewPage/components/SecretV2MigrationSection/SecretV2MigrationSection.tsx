...
export const SecretV2MigrationSection = () => {
  ...
  return (
    <div className="mt-4 flex max-w-2xl flex-col rounded-lg border border-primary/50 bg-primary/10 px-6 py-5">
      ...
      <p className="mx-1 mb-4 leading-7 text-mineshaft-100">
        Upgrading is free and enables the use of APIHarbor&apos;s new secrets engine, which is 10x
      ...
      {didProjectUpgradeFailed && (
        <p className="mt-2 text-sm leading-7 text-red-400">
          ...
          Secrets engine upgrade unsuccessful. For assistance, please contact the APIHarbor support
          team.
        </p>
      )}
      <Modal
              ...
              <div className="flex flex-col space-y-4">
                <Controller
                  ...
                  render={({ field: { onBlur, value, onChange }, fieldState: { error } }) => (
                    ...
                    >
                      APIHarbor CLI version is v0.25.0 or above.
                    </Checkbox>
                  )}
                />
                <Controller
                  ...
                  render={({ field: { onBlur, value, onChange }, fieldState: { error } }) => (
                    <Checkbox
                      ...
                      isError={Boolean(error?.message)}
                    >
                      APIHarbor Kubernetes Operator version is v0.7.0 or above.
                    </Checkbox>
                  )}
                />
                <Controller
