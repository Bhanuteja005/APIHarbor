    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="After adding the details below, you will be prompted to set up an integration for a particular APIHarbor project and environment."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              ...
              href="https://apiharbor.com/docs/integrations/cloud/aws-parameter-store"
            >
