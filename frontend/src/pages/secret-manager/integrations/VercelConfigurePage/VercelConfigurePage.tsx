...
const initialSyncBehaviors = [
  ...
  {
    label: "Import - Prefer values from APIHarbor",
    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle="Select which environment or folder in APIHarbor you want to sync to Vercel's environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              target="_blank"
              href="https://apiharbor.com/docs/integrations/cloud/vercel"
        ...
        <FormControl label="APIHarbor Project Environment" className="px-6">
          <Select
        ...
        <FormControl
          ...
          helperText={
            <Tooltip
              className="max-w-md"
              content="Double check APIHarbor's access permissions in Vercel by navigating to Team > Integrations > APIHarbor > Settings > Manage Access."
            >
              <div>
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Vercel with secrets from APIHarbor.
        </span>
      </div>
    </div>
  ) : (
