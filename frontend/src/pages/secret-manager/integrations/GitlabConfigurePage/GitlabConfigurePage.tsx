...
const initialSyncBehaviors = [
  ...
  { label: "Import - Prefer values from APIHarbor", value: IntegrationSyncBehavior.PREFER_SOURCE }
];
    ...
    >
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Select which environment or folder in APIHarbor you want to sync to GitLab's environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cicd/gitlab"
              target="_blank"
                  ...
                  render={({ field: { onChange, value } }) => (
                    ...
                    >
                      <div className="max-w-md">
                        Mark APIHarbor secrets in Gitlab as &apos;Masked&apos; secrets
                      </div>
                    </Switch>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Switch
                      ...
                      isChecked={value}
                    >
                      Mark APIHarbor secrets in Gitlab as &apos;Protected&apos; secrets
                    </Switch>
                  )}
                />
              </div>
