    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="mb-12 max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="After adding your API Token, you will be prompted to set up an integration for a particular APIHarbor project and environment."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              ...
              href="https://apiharbor.com/docs/integrations/cicd/circleci"
            >
