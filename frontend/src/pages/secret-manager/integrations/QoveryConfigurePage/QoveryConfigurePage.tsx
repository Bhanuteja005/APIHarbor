    ...
    <div className="flex h-full w-full flex-col items-center justify-center bg-linear-to-tr from-mineshaft-900 to-bunker-900">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle="Choose which environment in APIHarbor you want to sync to Checkly environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/qovery"
              target="_blank"
        ...
        <Tabs defaultValue={TabSections.InfisicalSettings} className="px-6">
          <TabList>
            <div className="flex w-full flex-row border-b border-mineshaft-600">
              <Tab value={TabSections.InfisicalSettings}>APIHarbor Settings</Tab>
          ...
          <TabPanel value={TabSections.InfisicalSettings}>
            ...
            >
              <FormControl label="APIHarbor Project Environment">
                <Select
      ...
      <div className="flex flex-col bg-mineshaft-800 border border-mineshaft-600 w-full p-4 max-w-lg mt-6 rounded-md">
        ...
        <span className="text-mineshaft-300 text-sm mt-4">After creating an integration, your secrets will start syncing immediately. This might cause an unexpected override of current secrets in Qovery with secrets from APIHarbor.</span>
      </div> */}
    </div>
  ) : (
