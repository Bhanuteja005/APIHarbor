    ...
    >
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Choose which environment or folder in APIHarbor you want to sync to Render environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/render"
              target="_blank"
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Render with secrets from APIHarbor.
        </span>
      </div>
    </form>
  ) : (
