    ...
    >
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Choose which environment in APIHarbor you want to sync to your Azure App Configuration."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/azure-app-configuration"
              target="_blank"
