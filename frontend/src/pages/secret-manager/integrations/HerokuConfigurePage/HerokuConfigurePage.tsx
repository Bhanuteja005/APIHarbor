    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle="Select which environment or folder in APIHarbor you want to sync to Heroku's environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/heroku"
              target="_blank"
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Heroku with secrets from APIHarbor.
        </span>
      </div></>} */}
    </div>
  ) : (
