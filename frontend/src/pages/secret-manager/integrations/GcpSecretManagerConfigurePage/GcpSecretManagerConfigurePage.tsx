    ...
    >
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        ...
        <CardTitle
          ...
          subTitle="Select which environment or folder in APIHarbor you want to sync to GCP Secret Manager."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              ...
              href="https://apiharbor.com/docs/integrations/cloud/gcp-secret-manager"
            >
