    ...
    <div className="flex h-full w-full items-center justify-center bg-linear-to-tr from-mineshaft-900 to-bunker-900">
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle="Choose which environment in APIHarbor you want to sync with your Cloudflare Workers project."
        >
          Cloudflare Workers Integration
        </CardTitle>
        <FormControl label="APIHarbor Project Environment" className="mt-2 px-6">
          <Select
        ...
        <FormControl label="APIHarbor Secret Path" className="mt-2 px-6">
          <SecretPathInput
            value={secretPath}
