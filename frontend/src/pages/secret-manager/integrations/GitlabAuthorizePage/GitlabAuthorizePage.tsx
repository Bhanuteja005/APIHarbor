    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="mb-12 max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Authorize this integration to sync secrets from APIHarbor to GitLab. If no self-hosted GitLab URL is specified, then APIHarbor will connect you to GitLab Cloud."
        >
