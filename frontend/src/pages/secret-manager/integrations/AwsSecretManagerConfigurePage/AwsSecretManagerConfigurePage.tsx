...
const mappingBehaviors = [
  {
    label: "Many to One (All APIHarbor secrets will be mapped to a single AWS secret)",
    value: IntegrationMappingBehavior.MANY_TO_ONE
  },
  {
    label: "One to One - (Each APIHarbor secret will be mapped to its own AWS secret)",
      ...
      <form onSubmit={handleSubmit(handleButtonClick)}>
        <Card className="max-w-lg rounded-md border border-mineshaft-600">
          <CardTitle
            ...
            subTitle="Choose which environment in APIHarbor you want to sync to secerts in AWS Secrets Manager."
          >
            <div className="flex flex-row items-center">
              ...
              <a
                href="https://apiharbor.com/docs/integrations/cloud/aws-secret-manager"
                target="_blank"
