...
const initialSyncBehaviors = [
  ...
  {
    label: "Import non-sensitive - Prefer values from APIHarbor",
    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Specify the encironment and path within APIHarbor that you want to push to which project in Terraform."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              ...
              href="https://apiharbor.com/docs/integrations/cloud/terraform-cloud"
            >
