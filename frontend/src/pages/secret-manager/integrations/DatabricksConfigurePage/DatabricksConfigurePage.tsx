    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Choose which environment or folder in APIHarbor you want to sync to which Databricks secrets scope."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/databricks"
              target="_blank"
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          When integrating with Databricks, APIHarbor is intended to be the source of truth for the
          secrets in the configured Databricks scope.
        </span>
        <span className="mt-4 text-sm text-mineshaft-300">
          Any secrets not present in APIHarbor will be removed from the specified scope. To prevent
          removal of secrets not managed by APIHarbor, APIHarbor recommends creating a designated
