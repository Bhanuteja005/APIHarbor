    ...
    <div className="flex h-full w-full flex-col items-center justify-center py-4">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <form onSubmit={handleSubmit(onFormSubmit)} className="px-6">
          <CardTitle
            ...
            subTitle="Choose which environment in APIHarbor you want to sync to environment variables in GitHub."
          >
            <div className="flex flex-row items-center">
              ...
              <a
                ...
                href="https://apiharbor.com/docs/integrations/cicd/githubactions"
              >
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <Switch
                        ...
                        isChecked={value}
                      >
                        Delete secrets in Github that are not in APIHarbor
                      </Switch>
                    )}
                  />
                </div>
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in GitHub with secrets from APIHarbor.
        </span>
      </div>
    </div>
  ) : (
