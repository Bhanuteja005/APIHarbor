    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle="Choose which environment or folder in APIHarbor you want to sync to Fly.io environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <a
              href="https://apiharbor.com/docs/integrations/cloud/flyio"
              target="_blank"
        ...
        <div className="px-6 pb-4">
          <Alert hideTitle variant="warning">
            <AlertDescription>
              ...
              APIHarbor secrets are pushed to your Fly.io project.
            </AlertDescription>
          </Alert>
        </div>
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Fly.io with secrets from APIHarbor.
        </span>
      </div>
    </div>
  ) : (
