    ...
    >
      <div className="mb-6 rounded-lg border border-mineshaft-600 bg-mineshaft-900 p-4">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex w-full justify-end pr-4">
            <a
              ...
              href="https://apiharbor.com/docs/documentation/platform/kms"
            >
        ...
        <UpgradePlanModal
          ...
          text="Your current plan does not include access to KMIP. To unlock this feature, please upgrade to APIHarbor Enterprise plan."
