  ...
  const handleAddSshHostGroupModal = () => {
    if (!subscription?.sshHostGroups) {
      handlePopUpOpen("upgradePlan", {
        text: "Managing SSH host groups can be unlocked if you upgrade to APIHarbor Enterprise plan.",
      ...
      <div className="mb-4 flex justify-between">
        ...
        <div className="flex justify-end">
          <a
            ...
            href="https://apiharbor.com/docs/documentation/platform/ssh/host-groups"
          >
