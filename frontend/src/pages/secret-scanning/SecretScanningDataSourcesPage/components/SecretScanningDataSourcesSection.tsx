  ...
  return (
    <>
        ...
        <div className="mb-4 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-x-2">
              ...
              <DocumentationLinkBadge href="https://apiharbor.com/docs/documentation/platform/secret-scanning/overview" />
            </div>
      ...
      <UpgradePlanModal
        ...
        text="Creating data sources can be unlocked if you upgrade to APIHarbor Enterprise plan."
