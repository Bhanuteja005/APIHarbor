...
export const STEPS: WizardStep[] = [
  {
    ...
    rightLabel: "BASICS",
    rightDescription:
      "The name identifies the CA inside APIHarbor. A Root CA is self-signed and active immediately. An Intermediate CA is created pending a certificate, then signed by a parent CA after you generate its CSR.",
  ...
  },
  {
    ...
    rightDescription:
      "Pick the key source: APIHarbor generates and manages the keypair, or HSM keeps the keypair inside your own Hardware Security Module and performs every signature there. Root CAs are self-signed immediately, so their validity and path length are set here.",
    docsUrl: PkiDocsUrls.ca.internal
  },
  {
    name: "Distribution",
    ...
    rightDescription:
      "Certificates issued by this CA carry CRL Distribution Point URLs so clients can check revocation. The APIHarbor-managed CRL endpoint is included by default; add backup URLs or disable the managed one as needed.",
    docsUrl: PkiDocsUrls.ca.internal
  }
];
