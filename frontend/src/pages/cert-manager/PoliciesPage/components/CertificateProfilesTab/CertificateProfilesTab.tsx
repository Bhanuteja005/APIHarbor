  ...
  return (
    <Card>
      ...
      <UpgradePlanModal
        ...
        text="Your current plan does not include access to managing template enrollment options for ACME. To unlock this feature, please upgrade to APIHarbor Enterprise plan."
      />
