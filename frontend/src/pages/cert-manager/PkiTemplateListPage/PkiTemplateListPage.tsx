  ...
  return (
    <>
      ...
      <UpgradePlanModal
        ...
        text="Your current plan does not include access to configuring template enrollment methods. To unlock this feature, please upgrade to APIHarbor Enterprise plan."
