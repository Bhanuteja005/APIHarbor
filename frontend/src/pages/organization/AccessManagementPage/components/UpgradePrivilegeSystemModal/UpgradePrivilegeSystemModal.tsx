              ...
              <div className="mb-3">
                <div className="mb-3">
                  ...
                  <p className="text-sm text-mineshaft-300">
                    ...
                    <a
                      href="https://apiharbor.com/docs/internals/permissions/organization-permissions#subject%3A-groups"
                      target="_blank"
                      rel="noreferrer"
                    ...
                    and{" "}
                    <a
                      href="https://apiharbor.com/docs/internals/permissions/organization-permissions#subject%3A-identity"
                      target="_blank"
                      rel="noreferrer"
                      className="underline hover:text-bunker-200 hover:decoration-primary-700"
                    >
                    ...
                    <a
                      href="https://apiharbor.com/docs/internals/permissions/project-permissions#subject%3A-member"
                      target="_blank"
                      rel="noreferrer"
                      className="underline hover:text-bunker-200 hover:decoration-primary-700"
                    >
                    ...
                    <a
                      href="https://apiharbor.com/docs/internals/permissions/project-permissions#subject%3A-groups"
                      target="_blank"
                      rel="noreferrer"
                      className="underline hover:text-bunker-200 hover:decoration-primary-700"
                    >
                    ...
                    and{" "}
                    <a
                      href="https://apiharbor.com/docs/internals/permissions/project-permissions#subject%3A-identity"
                      target="_blank"
                      rel="noreferrer"
                      className="underline hover:text-bunker-200 hover:decoration-primary-700"
                    >
