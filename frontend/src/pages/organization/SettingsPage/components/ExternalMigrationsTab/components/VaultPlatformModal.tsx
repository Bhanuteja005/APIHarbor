...
const MAPPING_TYPE_MENU_ITEMS = [
  {
    ...
    tooltip: (
      <div>
        When using key vaults for mapping, each key vault within Vault will be created in APIHarbor
  ...
  },
  {
    ...
    tooltip: (
      <div>
        When using namespaces for mapping, each namespace within Vault will be created in APIHarbor
