          ...
          <div className="mb-6 rounded-lg border border-mineshaft-600 bg-mineshaft-900 p-4">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-x-2">
                ...
                <DocumentationLinkBadge href="https://apiharbor.com/docs/documentation/platform/project-templates" />
              </div>
              <OrgPermissionCan
            ...
            <UpgradePlanModal
              ...
              text="Your current plan does not include access to project templates. To unlock this feature, please upgrade to APIHarbor Enterprise plan."
