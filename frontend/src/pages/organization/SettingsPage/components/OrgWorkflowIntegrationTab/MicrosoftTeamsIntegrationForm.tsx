  ...
  return (
    <form onSubmit={handleSubmit(handleMicrosoftTeamsFormSubmit)} autoComplete="off">
      <div className="mb-4 text-xs text-mineshaft-200">
        For seamless installations, ensure that the APIHarbor bot is already installed in your
        Microsoft Teams tenant. For more information, please refer to the{" "}
        <a
          className="text-primary-500"
          href="https://apiharbor.com/docs/documentation/platform/workflow-integrations/microsoft-teams-integration"
          target="_blank"
