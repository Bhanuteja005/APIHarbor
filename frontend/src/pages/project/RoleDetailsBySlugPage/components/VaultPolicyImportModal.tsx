          ...
          <div>
            ...
            <div className="space-y-1.5 text-xs leading-relaxed">
              ...
              <p>
                ...
                automatically mapped to equivalent APIHarbor permissions and glob patterns.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
      <ModalContent
        ...
        subTitle="Select a policy from your Vault namespace or paste your own HCL policy to translate it into APIHarbor permissions."
        className="max-w-4xl"
      >
