  ...
  <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
    <ModalContent title="Email service not configured">
      <p className="mb-4 text-bunker-300">
        The administrators of this APIHarbor instance have not yet set up an email service provider
        required to perform this action
      </p>

      <a href="https://apiharbor.com/docs/self-hosting/configuration/email">
