  ...
  return (
    ...
    >
      <p className="mb-8 text-sm text-mineshaft-200">
        Are you sure you want to remove certificates synced by APIHarbor from this {destinationName}{" "}
        destination?
      </p>
  ...
  return (
    <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
      <ModalContent
        ...
        subTitle={`Remove certificates synced by APIHarbor from this ${destinationName} Sync destination.`}
      >
