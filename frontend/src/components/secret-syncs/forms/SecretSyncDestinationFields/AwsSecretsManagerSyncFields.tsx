              ...
              <Tooltip>
                ...
                <TooltipContent className="max-w-lg">
                  <div className="flex flex-col gap-3">
                    <p>Specify how APIHarbor should map secrets to AWS Secrets Manager:</p>
                    <ul className="flex list-disc flex-col gap-3 pl-4">
                      <li>
                        <p className="text-mineshaft-300">
                          <span className="font-medium text-bunker-200">One-To-One</span>: Each
                          APIHarbor secret will be mapped to a separate AWS Secrets Manager secret.
                        </p>
                      </li>
                      <li>
                        <p className="text-mineshaft-300">
                          <span className="font-medium text-bunker-200">Many-To-One</span>: All
                          APIHarbor secrets will be mapped to a single AWS Secrets Manager secret.
                        </p>
                      </li>
                    </ul>
                  </div>
